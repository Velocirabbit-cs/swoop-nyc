...
import Item from '../client/components/containers/Item';
import Listings from '../client/components/containers/Listings';
...
describe('Unit testing React components', () => {
  describe('ItemViewer test', () => {
    ...
    beforeAll(() => {
      text = render(<ItemView item={item} />)
    });
  
    test('itemView receives props from item component', () => {
  
      expect(text.getByText("item1Title").toBeEqualTo('Markets');
